                ...
                <div class="p-5 bg-light rounded-3 border col-xl-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            id="firstName" value="" placeholder="Enter First Name">
                            @error('firstName')
                            <div class="text-danger" > @error('firstName') first Name tidak sesuai @enderror</div>
                             @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input class="form-control" type="text" name="lastName" id="lastName"
                             ...
                             @error('lastName')
                             <div class="text-danger">@error('lastName') Last Name harus diisi @enderror</div>
                              @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            @error('email')
                            <div class="text-danger">@error('email')  email harus diisi @enderror</div>
                             @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            @error('age')
                            <div class="text-danger">@error('age') Age Harus diisi @enderror</div>
                             @enderror
                        </div>
                    </div>
                    <hr>
